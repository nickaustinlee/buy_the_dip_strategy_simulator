...
from buy_the_dip.cli.cli import (
    parse_date, parse_period, resolve_date_range, create_parser,
    format_backtest_result, format_evaluation_result, format_portfolio_status
)
...
class TestArgumentParser:
    ...
    def test_parser_creation(self):
        ...
        assert parser.description == "Buy the Dip Strategy - Dollar-cost averaging during market downturns"
